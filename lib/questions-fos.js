...
//
// Every client-facing string in this file is transcribed from that PDF. It is
// not re-worded, expanded or supplemented: no question, option, example or
// "I don't know" answer has been added, and no affordability calculation is
// derived from the financial answers.
//
// Two section headings in the source are written from the perspective of a
// professional representative rather than the client
// ("Tailoring to their circumstances", "Your customer's finances when they
// borrowed"). They are reproduced verbatim as approved wording and flagged in
// README.md under "Source ambiguities" rather than silently corrected.
//
...
const FOS_QUESTIONS = [
  {
    ...
    heading: '1. Vulnerabilities (“Tailoring to their circumstances”)',
  ...
  {
    id: 'FOS_INCOME',
    // The source uses a straight apostrophe here and curly quotation marks
    // around the heading; both are reproduced exactly.
    heading: "6. “Your customer's finances when they borrowed”",
...
module.exports = {
  ...
  EXAMPLES_INTRO, EXAMPLES_TOGGLE,
